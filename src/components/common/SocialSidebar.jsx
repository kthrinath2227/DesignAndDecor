...
import { BedDouble, Sofa, Palette, Instagram, MessageCircle } from "lucide-react";
...
export function SocialSidebar({ setActiveDecor }) {
  const socialLinks = [
    ...
    { icon: MessageCircle, label: "WhatsApp", link: "https://wa.me/+919160000002" },
  ...
  return (
    <div
      className="
        ...
        w-20 md:w-20 sm:w-16 xs:w-12
      "
    >
      <div className="flex flex-col space-y-6 relative">
        {/* DECOR heading */}
        <div className="relative flex flex-col items-center">
          <span className="text-xs tracking-widest transform -rotate-90 text-[#dbb980] mb-10 sm:mb-8 xs:mb-6">
            DECOR
          </span>
          <div className="absolute w-px h-10 sm:h-8 xs:h-6 bg-gray-700" />
        </div>
          ...
          return (
            <motion.a
              ...
              className="
                ...
                w-10 h-10 md:w-10 md:h-10 sm:w-8 sm:h-8 xs:w-6 xs:h-6
              "
            ...
            >
              <Icon
                aria-label={label}
                className="
                  w-6 h-6 md:w-6 md:h-6 sm:w-5 sm:h-5 xs:w-4 xs:h-4
              ...
              <span
                className="
                  absolute left-12 sm:left-10 xs:left-8
                  px-3 py-1 text-xs sm:text-[10px] xs:text-[8px]
