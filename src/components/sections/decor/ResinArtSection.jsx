...
export function ResinArtSection() {
  ...
  <div className="w-full aspect-video rounded-xl overflow-hidden shadow-lg">
    <video
      src="https://res.cloudinary.com/dzwxkhkvi/video/upload/v1759045558/DIY_Beach_Tray_craftideas_craft_handmade_ocean_resin_-_Create_with_Colorstory_720p_h264_sufntp.mp4"
      autoPlay
      loop
      playsInline
      preload="metadata"
    ...
    />
      ...
      <div className="max-w-7xl w-full flex flex-col lg:flex-row items-center lg:items-start gap-8">
        ...
        {/* Left Image */}
        <img
          src="https://res.cloudinary.com/dzwxkhkvi/image/upload/v1758953512/istockphoto-1320046206-612x612_s9gv2q.jpg"
          alt="chair"
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left max-w-xl md:max-w-2xl">
          <h1 className="text-2xl sm:text-3xl lg:text-5xl font-bold text-gray-900 mb-4 m-1 leading-snug">
            Discover Nature Inspired Arts collection
          </h1>
      ...
      Our Nature-Inspired Arts Collection celebrates minimalist design
      and the timeless beauty of the great indoors. Each piece blends form
      and function in perfect harmony.
        ...
        {/* Right Image */}
        <img
          src="https://res.cloudinary.com/dzwxkhkvi/image/upload/v1758953509/istockphoto-1314923183-612x612_jtolsx.jpg"
          alt="stool"
          className="w-40 sm:w-48 md:w-56 lg:w-64 h-auto object-contain shadow-lg"
          loading="lazy"
        />
    ...
    <section className="w-full bg-gray-900 flex flex-col items-center text-center px-6 py-20">
      ...
      <h1 className="text-1xl ml-10 md:text-3xl lg:text-3xl tracking-widest text-[#dbb980] uppercase mb-10">
        Beautiful Arts. <br /> Increased Interior Beauty.
      </h1>
    
      {/* Image with overlay card */}
      <div className="relative w-full m-10">
              <motion.img
                src="https://res.cloudinary.com/dzwxkhkvi/image/upload/v1759043551/Trendy_7_Drawing_Ideas__Refresh_Your_Creative_Toolbox_w71rrn.jpg"
                alt="decorative"
              ...
              <div className="absolute left-1/2 w-[80%] sm:w-4/5 max-w-[90%] " style={{ top: "80%" }}>
                <div className="ml-10 bg-white text-gray-900 rounded-xl shadow-lg p-4 sm:p-6 w-full -translate-x-1/2">
                  ...
                  <p className="text-xs sm:text-sm md:text-base text-gray-700">
                    Experience Arts that blends comfort, style, and timeless quality.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="ml-10 grid grid-cols-1 md:grid-cols-2 gap-8 shadow-lg">
        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-md text-gray-200">
          <p>"Amazing arts and excellent service!"</p>
